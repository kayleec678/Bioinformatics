...
```
## Vectors and Subsets
Each exercise has to do with vectors. 
...
```
## Ggplot
Each exercise has to do with Ggplot functions.  
...
```{r include=TRUE}
Dataset_S1$Divergence <- cut(Dataset_S1$Divergence, 5)
```
...
## Indexing
This section contains information on indexing (ie using lists)
...
##Loops 
This section contains information about if/else statements, for loops, and while functions. 
...
## Graphs
This section contains information about logs and how to incorporate them into R, typically uses ggplot (see ggplot).
...
## Coding Diagrams
This section is about how to create coding diagrams (or ideas about the code).
...
## Types of Values
This section shows the different values and what they mean within the context of R.
...
## Boolean
Shows if values are a number, equal to, or if there is nothing there. 
...
How to manipulate and add to data frames. 
...
Allows for manipulation of differnt file formats 
...
Making a new column
Allows for new values to be added to a column/data set. 
...
Deleting data
Gits rid of unnecessary or junk data. 
...
Saving dataframe
Allows to save data frame in a specific format. 

```{r}
write.csv(dataframe,"//Users//----//Desktop//Bioinformatics//dataframe.csv ")
```
